...
API_CLIENT_ID = CONFIG_PROVIDER.get('API_CLIENT_ID', settings.API_CLIENT_ID)
API_CLIENT_SECRET =CONFIG_PROVIDER.get('API_CLIENT_SECRET', settings.API_CLIENT_SECRET)
BASE_URL = CONFIG_PROVIDER.get('API_ENDPOINT', settings.API_ENDPOINT)
